        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUsers_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserNominations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserNominations_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserNominations_Nominations_NominationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserNominations_AppUserId",
                table: "AppUserNominations",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserNominations_NominationId",
                table: "AppUserNominations",
                column: "NominationId");
